/**
 * Reusable hero header for admin pages — yellow eyebrow, title, subtitle,
 * optional right-aligned action slot. Subtle radial yellow glow + grid
 * pattern matches the client app so admin and trader UIs read as one
 * coherent product.
 */
